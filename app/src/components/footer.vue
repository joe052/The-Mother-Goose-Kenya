    ...
    <div class="relative inset-0 bg-black opacity-80">
      ...
      >
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="text-center sm:text-left">
            <p class="text-lg font-medium text-orange-300">Resources</p>
          ...
          <div class="text-center sm:text-left">
            <p class="text-lg font-medium text-orange-300">Helpful Links</p>
        ...
        <div class="mt-16">
          ...
          <div class="mt-16 sm:flex sm:items-center sm:justify-between">
            ...
            >
              Copyright &copy; tabernacle.org {{ new Date().getFullYear() }}.
              All rights reserved.
            </p>
